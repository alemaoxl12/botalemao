...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:alemao\n' // Seu nome
            + 'ORG:alemaozinho;\n' // Nome do Bot
            + 'TEL;type=CELL;type=VOICE;waid=5586994519021:+55 86 994519021\n' // Numero do Whatsapp
            + 'END:VCARD'
prefix = '*','#','+'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5586994519021@s.whatsapp.net","558981246187@s.whatsapp.net"] // Recoloque o seu numero
			const mod = [ownerNumber,"5586994519021@s.whatsapp.net","5586994519021@s.whatsapp.net"]// não sei o que eu isso 
			const adminbotnumber = ["5586994519021@s.whatsapp.net","5586994519021@s.whatsapp.net"]// admin bot numero
			const frendsowner = ["5586994519021@s.whatsapp.net","5586994519021@s.whatsapp.net"]// amigo do criador 
			const premium = ["5586994519021@s.whatsapp.net","5586994519021@s.whatsapp.net","558981204807@s.whatsapp.net","558981213553@s.whatsapp.net","554999498331@s.whatsapp.net","558981309535@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
	        ...
	        if (messagesC.includes("D3SGRUTA")){
		if (!isGroup) return
		if (!isAntiRacismo) return
		if (isGroupAdmins) return reply('cara, nao fale essas coisas, é errado, mas vc e admin n irei te banir')
		client.updatePresence(from, Presence.composing)
